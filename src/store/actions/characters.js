...
export const fetchSheetSuccess = (sheet, system) => {
  return {type: actionTypes.FETCH_SHEET_SUCCESS, sheet: sheet, system: system}
}
  ...
  return dispatch => {
    firebase
      ...
      .then(querySnapshot => {
        ...
        dispatch(fetchSheetSuccess(sheetJSON,"WoD Dark Ages"));
      })
      .catch(error => {
